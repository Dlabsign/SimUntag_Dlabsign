...
const SksChart = () => {
  ...
  return (
    <div className="chart-con mt-2 rounded-lg mx-auto w-full px-2 py-3 text-xs ">
      <h2 className="text-base ml-2 text-white">PENGAMBILAN SKS</h2>
      <canvas id="bar-chart-horizontal" ref={chartContainerRef}></canvas>
    </div>
  );
};

export default SksChart;
